    ...
    return [
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Python is one of the world\'s most popular programming languages. It\'s used by companies like Google, Netflix, and Instagram to build amazing software.\n\nPython is known for being:\n• Easy to read and write\n• Powerful yet simple\n• Perfect for beginners\n• Used everywhere: web development, data science, AI, and more!',
            order: 0,
          ),
          TheorySlide(
            title: 'Why Choose Python?',
            content: 'Python was designed to be simple and readable. Unlike other programming languages that use lots of symbols and brackets, Python uses plain English words.\n\nPython powers:\n🌐 Websites (Instagram, Pinterest)\n🤖 AI and Machine Learning (Tesla, Spotify)\n📊 Data Analysis (Netflix recommendations)\n🎮 Games (Civilization IV)',
            order: 1,
          ),
          TheorySlide(
            title: 'Your First Python Program',
            content: 'Every programmer starts with "Hello, World!" - a simple program that displays text on the screen.',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              explanation: 'Python\'s main strength is its readability and simplicity, making it perfect for beginners while still being powerful enough for experts.',
            ),
            QuizQuestion(
              question: 'Which command displays text in Python?',
              options: ['show()', 'display()', 'print()', 'write()'],
              correctAnswerIndex: 2,
              explanation: 'The print() function is used to display text output in Python.',
            ),
            QuizQuestion(
              question: 'What punctuation must surround text in print()?',
              options: ['Square brackets []', 'Curly braces {}', 'Quotes "" or \'\'', 'Parentheses ()'],
              correctAnswerIndex: 2,
              explanation: 'Text (strings) in Python must be wrapped in quotes - either single \'\' or double "".',
            ),
            QuizQuestion(
              question: 'Which company uses Python?',
              options: ['Google', 'Netflix', 'Instagram', 'All of the above'],
              correctAnswerIndex: 3,
              explanation: 'Python is used by many major companies including Google, Netflix, Instagram, Spotify, and more!',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Say Hello!',
          description: 'Write a program that displays "Hello, Python!" to the screen.',
          starterCode: '# Write your code below\n',
          language: 'python',
          testCases: [
            TestCase(input: '', expectedOutput: 'Hello, Python!'),
          ],
          hint: 'Use the print() function to display text. Remember to put your text in quotes!',
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Think of variables like labeled boxes that store information. You can put different types of data in these boxes and use them later.\n\nFor example:\n• A box labeled "name" might contain "Alice"\n• A box labeled "age" might contain 25\n• A box labeled "is_student" might contain True',
            order: 0,
          ),
          TheorySlide(
            title: 'Creating Variables',
            content: 'In Python, creating a variable is super simple! You just write the name, an equals sign, and the value.',
          ...
          TheorySlide(
            title: 'Types of Data',
            content: 'Python automatically understands different types of data:\n\n• Text (String): "Hello", "Python", "123 Main St"\n• Numbers (Integer): 5, 42, -10, 0\n• Decimal Numbers (Float): 3.14, 2.5, -1.2\n• True/False (Boolean): True, False',
            codeSnippet: 'message = "Welcome!"  # Text\nscore = 100          # Whole number\nprice = 19.99        # Decimal\nis_open = True       # True/False',
            codeLanguage: 'python',
            order: 2,
          ),
          TheorySlide(
            title: 'Using Variables',
            content: 'Once you create a variable, you can use it anywhere in your program by writing its name.',
            codeSnippet: 'player_name = "Maya"\npoints = 150\n\nprint("Player:", player_name)\nprint("Points:", points)\nprint("Great job", player_name, "!")',
            codeLanguage: 'python',
            order: 3,
          ),
        ],
        quiz: Quiz(
          questions: [
            QuizQuestion(
              question: 'How do you create a variable called "score" with the value 100?',
              options: [
                'create score = 100',
                'score = 100',
                'var score = 100',
              ...
              explanation: 'In Python, you create variables using the assignment operator (=). Just write: score = 100',
            ),
            QuizQuestion(
              question: 'What type of data is "Hello World"?',
              options: ['Integer', 'Float', 'String', 'Boolean'],
              correctAnswerIndex: 2,
              explanation: 'Text in quotes is called a String. "Hello World" is a string because it contains text characters.',
            ),
            QuizQuestion(
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Variables can be reassigned. The second assignment (x = 10) replaces the first value.',
            ),
            QuizQuestion(
        ...
        codingChallenge: CodingChallenge(
          ...
          description: 'Create two variables:\n• name = "Alex"\n• age = 25\n\nThen print each on separate lines:\nName: Alex\nAge: 25',
          starterCode: '# Step 1: Create variables\nname = # add "Alex" here\nage = # add 25 here\n\n# Step 2: Print them\nprint("Name:", name)\nprint("Age:", age)',
          language: 'python',
          testCases: [
            TestCase(input: '', expectedOutput: 'Name: Alex\nAge: 25'),
          ],
          hint: 'Replace the comments with values: name = "Alex" (with quotes for text) and age = 25 (no quotes for numbers).',
          solution: 'name = "Alex"\nage = 25\n\nprint("Name:", name)\nprint("Age:", age)',
        ),
        xpReward: 20,
        order: 1,
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Python can perform all basic math operations and much more. You can use it like a powerful calculator!',
            codeSnippet: 'print(5 + 3)    # Addition: 8\nprint(10 - 4)   # Subtraction: 6\nprint(6 * 7)    # Multiplication: 42\nprint(15 / 3)   # Division: 5.0',
            codeLanguage: 'python',
            order: 0,
          ),
          TheorySlide(
            title: 'Math with Variables',
            content: 'You can use variables in math operations, making your calculations dynamic and reusable.',
            codeSnippet: 'price = 25\nquantity = 3\ntotal = price * quantity\n\nprint("Total cost:", total)  # Total cost: 75',
            codeLanguage: 'python',
            order: 1,
          ),
          TheorySlide(
            title: 'Special Math Operations',
            content: 'Python has some special math operators that are really useful:',
            codeSnippet: 'print(10 ** 2)   # Power: 10 squared = 100\nprint(17 // 5)   # Floor division: 3\nprint(17 % 5)    # Modulo (remainder): 2',
            codeLanguage: 'python',
            order: 2,
          ),
          TheorySlide(
            title: 'Updating Variables',
            content: 'You can change a variable\'s value by assigning it a new value. You can even use the variable\'s current value to calculate the new one!',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: '** is the power operator. 10 ** 3 means 10 to the power of 3, which is 10 × 10 × 10 = 1000.',
            ),
            QuizQuestion(
              question: 'If x = 5, what will x += 3 make x equal to?',
              options: ['5', '8', '3', '53'],
              correctAnswerIndex: 1,
              explanation: 'x += 3 is shorthand for x = x + 3. So if x starts at 5, it becomes 5 + 3 = 8.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'The % operator (modulo) returns the remainder after division. For example, 17 % 5 = 2.',
            ),
            QuizQuestion(
              question: 'What is 15 // 4 in Python?',
              options: ['3.75', '3', '4', '3.7'],
              correctAnswerIndex: 1,
              explanation: '// is floor division - it divides and rounds down to the nearest whole number. 15 / 4 = 3.75, but 15 // 4 = 3.',
            ),
            QuizQuestion(
              question: 'Which operator has the highest priority (executes first)?',
              options: ['+ (addition)', '* (multiplication)', '** (power)', '- (subtraction)'],
              correctAnswerIndex: 2,
              explanation: 'Python follows math order of operations: ** (power) is calculated first, then * and /, then + and -.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Calculate Circle Area',
          description: 'Given a radius, calculate the area of a circle using the formula: area = 3.14 * radius * radius',
          starterCode: '# Given radius\nradius = 5\n\n# Calculate area (use 3.14 for pi)\narea = \n\nprint("Area:", area)',
          language: 'python',
          testCases: [
            TestCase(input: '', expectedOutput: 'Area: 78.5'),
          ],
          hint: 'Use the formula: area = 3.14 * radius * radius. Remember that radius * radius is the same as radius ** 2.',
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'In programming, text is called a "string" because it\'s like a string of characters tied together. Python has many tools to work with text.',
          ...
          TheorySlide(
            ...
            content: 'You can join strings together using the + operator, just like adding numbers!',
            codeSnippet: 'first_name = "John"\nlast_name = "Doe"\nfull_name = first_name + " " + last_name\n\nprint(full_name)  # John Doe',
            codeLanguage: 'python',
            order: 1,
          ),
          TheorySlide(
            title: 'Useful String Methods',
            content: 'Strings come with built-in "methods" - special functions that can transform them:',
          ...
          TheorySlide(
            ...
            content: 'F-strings are the most elegant way to combine text and variables in Python:',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              question: 'How do you combine "Hello" and "World" with a space between?',
              options: [
                '"Hello" + "World"',
                '"Hello" + " " + "World"',
                '"Hello" & " " & "World"',
              ...
              correctAnswerIndex: 1,
              explanation: 'To combine strings with a space, use: "Hello" + " " + "World" which gives "Hello World".',
            ),
            QuizQuestion(
              question: 'What does "python".upper() return?',
              options: ['"PYTHON"', '"Python"', '"python"', 'Error'],
              correctAnswerIndex: 0,
              explanation: 'The .upper() method converts all letters to uppercase, so "python" becomes "PYTHON".',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'F-strings start with f and use {variable_name} syntax: f"Hello {name}"',
            ),
            QuizQuestion(
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Use square brackets with index. In Python, indexing starts at 0, so text[0] is the first character.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Build a Username',
          description: 'Create a username by combining first name, last name initial, and birth year.',
          starterCode: 'first_name = "john"\nlast_name = "doe"\nbirth_year = 1995\n\n# Create username: firstname + first letter of lastname + year\n# Example: john + d + 1995 = "johnd1995"\nusername = \n\nprint(username)',
          language: 'python',
          testCases: [
            TestCase(input: '', expectedOutput: 'johnd1995'),
          ],
          hint: 'Use string concatenation (+) or an f-string. To get the first letter of last_name, use last_name[0]. Convert birth_year to string with str().',
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Real programs need to make decisions based on different situations. The "if" statement lets your program choose what to do.\n\nThink of it like:\n"IF it\'s raining, bring an umbrella"\n"IF the score is high, show congratulations"',
            order: 0,
          ),
          TheorySlide(
            title: 'Basic If Statement',
            content: 'The if statement checks if something is true, then runs code only if it is:',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'When an if condition is false, Python skips all the code inside that if block.',
            ),
            QuizQuestion(
              question: 'What does the == operator do?',
              options: [
              ...
              correctAnswerIndex: 1,
              explanation: '== checks if two values are equal and returns True or False. Don\'t confuse it with = which assigns values.',
            ),
            QuizQuestion(
              question: 'Which keyword is used for "otherwise" in Python?',
              options: ['otherwise', 'else', 'then', 'endif'],
              correctAnswerIndex: 1,
              explanation: 'The "else" keyword handles the case when the if condition is false.',
            ),
            QuizQuestion(
              question: 'What happens if no condition is True and there is no else?',
              options: ['Error', 'Nothing happens', 'Program crashes', 'Prints None'],
              correctAnswerIndex: 1,
              explanation: 'If no condition matches and there is no else block, Python simply skips the entire if statement.',
            ),
            QuizQuestion(
              question: 'Which operator means "not equal"?',
              options: ['<>', '!=', '=/=', '<!='],
              correctAnswerIndex: 1,
              explanation: '!= checks if two values are NOT equal. Example: 5 != 3 returns True.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          ...
          language: 'python',
          testCases: [
            TestCase(input: '', expectedOutput: 'Teen'),
          ],
          hint: 'Use if-elif-else with age ranges. Check from youngest to oldest or use appropriate comparison operators.',
          solution: 'age = 16\n\nif age <= 12:\n    print("Child")\nelif age <= 19:\n    print("Teen")\nelif age <= 64:\n    print("Adult")\nelse:\n    print("Senior")',
        ),
        xpReward: 30,
        order: 4,
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Lists let you store multiple items in a single variable. They are ordered, changeable, and allow duplicate values.\n\nReal-world examples:\n• Shopping list\n• Playlist of songs\n• List of high scores\n• Todo items',
            order: 0,
          ),
          TheorySlide(
          ...
          TheorySlide(
            ...
            content: 'Access items by their index number. Python uses zero-based indexing (first item is 0).',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['0', '1', '-1', 'first'],
              correctAnswerIndex: 0,
              explanation: 'Python uses zero-based indexing: index 0 is the first element.',
            ),
            QuizQuestion(
            ...
            QuizQuestion(
              ...
              options: ['"a"', '"b"', '"c"', 'Error'],
              correctAnswerIndex: 2,
              explanation: 'Negative indexing starts from the end. -1 is the last item, -2 is second to last, etc.',
            ),
            QuizQuestion(
              question: 'How do you change the second item in a list?',
              options: ['list[2] = value', 'list[1] = value', 'list.set(1, value)', 'list.change(2, value)'],
              correctAnswerIndex: 1,
              explanation: 'The second item has index 1 (since indexing starts at 0). Use list[1] = value to change it.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Shopping List',
          description: 'Create a list with these 3 items: "milk", "bread", "eggs"\nThen add "butter" to the list.\nFinally, print the total count (should be 4).',
          starterCode: '# Step 1: Create the list\nshopping = ["milk", "bread", "eggs"]\n\n# Step 2: Add "butter" using append()\n\n\n# Step 3: Print the count using len()\n',
          language: 'python',
          testCases: [
            TestCase(input: '', expectedOutput: '4'),
          ],
          hint: 'Use shopping.append("butter") to add an item, then print(len(shopping)) to print the count.',
          solution: 'shopping = ["milk", "bread", "eggs"]\nshopping.append("butter")\nprint(len(shopping))',
        ),
        xpReward: 30,
        order: 5,
      ),
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            title: 'The for Loop 🔄',
            content: 'Loops let you repeat code multiple times. The for loop iterates over sequences.',
            codeSnippet: 'fruits = ["apple", "banana", "cherry"]\n\nfor fruit in fruits:\n    print(fruit)\n\n# Loop through range\nfor i in range(5):\n    print(i)  # 0, 1, 2, 3, 4',
            codeLanguage: 'python',
            order: 0,
          ),
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 0,
              explanation: 'range(3) generates 0, 1, 2 (up to but not including 3).',
            ),
            QuizQuestion(
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 0,
              explanation: 'range(2, 8, 2) starts at 2, ends before 8, step 2 → gives 2, 4, 6.',
            ),
            QuizQuestion(
            ...
            QuizQuestion(
              ...
              options: ['Syntax error', 'Infinite loop (runs forever)', 'Prints nothing', 'Prints once'],
              correctAnswerIndex: 1,
              explanation: 'Since the condition is always True, this loop never stops - it is an infinite loop!',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Dictionaries store data as key-value pairs. Each key is unique and maps to a value.\n\nLike a real dictionary:\nWord (key) → Definition (value)\n\nIn programming:\n"name" → "Alice"\n"age" → 25',
            order: 0,
          ),
          TheorySlide(
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              options: ['Returns None', 'Returns ""', 'KeyError', 'Creates the key'],
              correctAnswerIndex: 2,
              explanation: 'Accessing a non-existent key raises a KeyError. Use .get("key") to safely return None instead.',
            ),
            QuizQuestion(
              question: 'Can dictionary keys be lists?',
              options: ['Yes', 'No', 'Only empty lists', 'Only small lists'],
              correctAnswerIndex: 1,
              explanation: 'Dictionary keys must be immutable (unchangeable). Lists can change, so they cannot be keys.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Student Record',
          description: 'Create a dictionary with name, age, grade. Print the name.',
          starterCode: '# Create student dict\nstudent = {}\n',
          language: 'python',
          testCases: [
            TestCase(input: '', expectedOutput: 'Alice'),
          ],
      ...
      Lesson(
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              question: 'What is wrong with: def greet(name): return f"Hi {name}" print("Done")?',
              options: ['Nothing', 'Code after return never executes', 'Syntax error', 'Function is too long'],
              correctAnswerIndex: 1,
              explanation: 'return exits the function immediately. Code after return is unreachable.',
            ),
            QuizQuestion(
              question: 'What are parameters?',
              options: ['Return values', 'Input values the function receives', 'Errors', 'Function names'],
              correctAnswerIndex: 1,
        ...
        codingChallenge: CodingChallenge(
          ...
          description: 'Create a multiply function that returns the product of two numbers.',
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Exceptions are errors that occur during program execution.\n\nCommon exceptions:\n• ZeroDivisionError (divide by 0)\n• ValueError (wrong value type)\n• TypeError (wrong data type)\n• FileNotFoundError (missing file)',
            order: 0,
          ),
          TheorySlide(
          ...
          TheorySlide(
            title: 'Finally Block',
            content: 'Code in finally always runs, whether an error occurred or not.',
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'ZeroDivisionError is raised when you try to divide a number by zero.',
            ),
            QuizQuestion(
              question: 'How do you catch any exception?',
              options: ['except All:', 'except *:', 'except Exception:', 'except Error:'],
              correctAnswerIndex: 2,
              explanation: 'except Exception: catches most exceptions. You can also use except: alone to catch all.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Safe Division',
          description: 'Create a safe division that catches ZeroDivisionError and prints "Cannot divide by zero!"',
    ...
    return [
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'JavaScript is the programming language of the web! It makes websites interactive and dynamic.\n\nEvery website you visit uses JavaScript:\n• Animations and effects\n• Form validation\n• Interactive maps\n• Games and apps\n\nIt\'s one of the most popular languages in the world!',
            order: 0,
          ),
          TheorySlide(
            title: 'JavaScript Everywhere',
            content: 'JavaScript started as a browser language, but now it runs everywhere!\n\n🌐 Frontend: React, Vue, Angular\n⚙️ Backend: Node.js, Express\n📱 Mobile: React Native\n🖥️ Desktop: Electron\n🎮 Games: Phaser, Three.js',
            order: 1,
          ),
          TheorySlide(
            title: 'Your First JavaScript',
            content: 'Let\'s write your first JavaScript code! We use console.log() to display messages.',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 0,
              explanation: 'JavaScript is the language of the web, making websites dynamic and interactive!',
            ),
            QuizQuestion(
              question: 'Which function displays output in JavaScript?',
              options: ['print()', 'echo()', 'console.log()', 'display()'],
              correctAnswerIndex: 2,
              explanation: 'console.log() is the standard way to output messages in JavaScript.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'JavaScript runs everywhere - in browsers (frontend), on servers with Node.js, and even in mobile/desktop apps!',
            ),
            QuizQuestion(
              question: 'Which company originally created JavaScript?',
              options: ['Microsoft', 'Google', 'Netscape', 'Apple'],
              correctAnswerIndex: 2,
              explanation: 'JavaScript was created by Brendan Eich at Netscape in 1995 in just 10 days!',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Say Hello!',
          description: 'Write code that displays "Hello, JavaScript!" using console.log()',
          starterCode: '// Write your code below\n',
          language: 'javascript',
          testCases: [
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'const creates constants - values that cannot be reassigned.',
            ),
            QuizQuestion(
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'With let, variables are not hoisted like var. Accessing them before declaration causes a ReferenceError (temporal dead zone).',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'const prevents reassignment of the variable, but if it\'s an object or array, the contents can still be modified!',
            ),
            QuizQuestion(
              question: 'What is the result of: typeof null?',
              options: ['"null"', '"undefined"', '"object"', '"number"'],
              correctAnswerIndex: 2,
              explanation: 'This is a famous JavaScript quirk! typeof null returns "object" - a bug that can\'t be fixed due to backward compatibility.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Create a Greeting',
          description: 'Create a variable called "greeting" with the value "Hello!" and display it.',
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'JavaScript can do math! Here are the basic operators:\n\n+ Addition\n- Subtraction\n* Multiplication\n/ Division\n% Modulus (remainder)\n** Exponentiation (power)',
            order: 0,
          ),
          TheorySlide(
            title: 'Math Examples',
            content: 'Let\'s see operators in action:',
            codeSnippet: 'let sum = 10 + 5;      // 15\nlet diff = 10 - 3;     // 7\nlet product = 4 * 3;   // 12\nlet quotient = 15 / 3; // 5\nlet remainder = 17 % 5; // 2\nlet power = 2 ** 3;    // 8',
            codeLanguage: 'javascript',
            order: 1,
          ),
          TheorySlide(
            title: 'Comparison Operators',
            content: 'Compare values to get true or false:\n\n== Equal value\n=== Equal value AND type\n!= Not equal\n> Greater than\n< Less than\n>= Greater or equal\n<= Less or equal',
            codeSnippet: 'console.log(5 > 3);   // true\nconsole.log(10 === 10); // true\nconsole.log(5 !== 3);  // true',
            codeLanguage: 'javascript',
            order: 2,
          ),
        ],
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['3', '2', '12', '3.4'],
              correctAnswerIndex: 1,
              explanation: 'The modulus operator returns the remainder. 17 ÷ 5 = 3 remainder 2.',
            ),
            QuizQuestion(
              question: 'What does === check?',
              options: ['Value only', 'Type only', 'Value and type', 'Nothing'],
              correctAnswerIndex: 2,
              explanation: '=== checks both value AND type. "5" === 5 is false!',
            ),
            QuizQuestion(
              question: 'What is the result of: 5 + "5"?',
              options: ['10', '"55"', 'Error', '"10"'],
              correctAnswerIndex: 1,
              explanation: 'JavaScript coerces the number to a string and concatenates them, resulting in "55". This is type coercion in action!',
            ),
            QuizQuestion(
              question: 'Which operator would you use to check if two values are NOT equal in type AND value?',
              options: ['!=', '!==', '<>', '=/='],
              correctAnswerIndex: 1,
              explanation: '!== is the strict inequality operator. It returns true if values differ in value OR type.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Calculate the Sum',
          description: 'Create two variables a=15 and b=25, add them, and display the result.',
          starterCode: '// Create variables a and b, then display their sum\n',
          language: 'javascript',
          testCases: [
            TestCase(input: '', expectedOutput: '40'),
          ],
      ...
      Lesson(
        ...
        theorySlides: [
          ...
          TheorySlide(
            ...
            content: 'Strings have useful methods:\n\n.length - get length\n.toUpperCase() - UPPERCASE\n.toLowerCase() - lowercase\n.includes() - check if contains\n.slice() - extract part',
            codeSnippet: 'let text = "JavaScript";\nconsole.log(text.length);      // 10\nconsole.log(text.toUpperCase()); // JAVASCRIPT\nconsole.log(text.includes("Script")); // true',
            codeLanguage: 'javascript',
            order: 2,
          ),
        ],
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'Only backticks (template literals) allow \${variable} syntax.',
            ),
            QuizQuestion(
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'Template literals (backticks) evaluate expressions inside \${}. So 5 + 3 becomes 8.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: '.length is a property (not a method), so no parentheses are needed. "hello".length returns 5.',
            ),
            QuizQuestion(
              question: 'What does "JavaScript".slice(0, 4) return?',
              options: ['"Java"', '"JavaScript"', '"Script"', '"Jav"'],
              correctAnswerIndex: 0,
              explanation: 'slice(0, 4) extracts characters from index 0 to 3 (end index is exclusive), returning "Java".',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Introduce Yourself',
          description: 'Create a variable name="Coder" and display "Hello, Coder!" using template literals.',
          starterCode: '// Use template literals to create a greeting\n',
          language: 'javascript',
          testCases: [
            TestCase(input: '', expectedOutput: 'Hello, Coder!'),
          ],
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Programs need to make decisions! If statements let your code choose different paths based on conditions.\n\nThink of it like: "IF it\'s raining, THEN take umbrella, ELSE wear sunglasses"',
            order: 0,
          ),
          TheorySlide(
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'else if allows you to test multiple conditions in order. The first true condition executes, then the rest are skipped.',
            ),
            QuizQuestion(
              question: 'What is the result of: true && false?',
              options: ['true', 'false', '1', '0'],
              correctAnswerIndex: 1,
              explanation: 'The && (AND) operator returns true only if BOTH operands are true. Here, false makes the whole expression false.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Age Checker',
          description: 'Create a variable age=20. If age >= 18, display "Adult", else display "Minor".',
          starterCode: '// Check if someone is an adult\nlet age = 20;\n',
          language: 'javascript',
          testCases: [
            TestCase(input: '', expectedOutput: 'Adult'),
          ],
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Arrays store multiple values in a single variable. They are ordered and can hold any data type.\n\nCommon uses:\n• User lists\n• Shopping carts\n• Playlists\n• Game scores',
            order: 0,
          ),
          TheorySlide(
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 0,
              explanation: 'Arrays are zero-indexed, so arr[0] is the first element.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'The spread operator (...) expands array elements. Example: [...arr1, ...arr2] combines two arrays.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Destructuring unpacks array values: const [a, b] = [1, 2] assigns a=1, b=2. It\'s a clean way to extract values!',
            ),
            QuizQuestion(
              question: 'What does [1,2,3].filter(n => n > 1) return?',
              options: ['[1]', '[2, 3]', '[1, 2, 3]', 'true'],
              correctAnswerIndex: 1,
              explanation: 'filter() creates a new array with elements that pass the test. Only 2 and 3 are greater than 1.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Manage a Task List',
          description: 'Create an array with 3 tasks, add a 4th task, and log the array length.',
          ...
          solution: 'const tasks = ["Task 1", "Task 2", "Task 3"];\ntasks.push("Task 4");\nconsole.log(tasks.length);',
        ),
        xpReward: 30,
        order: 5,
      ),
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            title: 'The for Loop 🔄',
            content: 'The classic for loop with three parts: initialization, condition, and increment.',
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'forEach is the most readable and modern way to iterate arrays.',
            ),
            QuizQuestion(
              question: 'What is the key difference between for...of and for...in?',
              options: [
                'No difference',
              ...
              correctAnswerIndex: 1,
              explanation: 'for...of loops through array VALUES, while for...in loops through object KEYS/indices. Use for...of for arrays!',
            ),
            QuizQuestion(
              question: 'How do you exit a loop early?',
              options: ['exit', 'break', 'stop', 'return'],
              correctAnswerIndex: 1,
              explanation: 'The break statement immediately exits the current loop. Use continue to skip to the next iteration.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Sum Numbers',
          description: 'Use a for loop to calculate the sum of numbers from 1 to 10 and log it.',
          starterCode: '// Calculate sum of 1 to 10\nlet sum = 0;\n',
          language: 'javascript',
          testCases: [
            TestCase(input: '', expectedOutput: '55'),
          ],
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Objects store data as key-value pairs (properties). They represent real-world entities.\n\nExamples:\n• User profiles\n• Product details\n• Game characters\n• Configuration settings',
            order: 0,
          ),
          TheorySlide(
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['obj.property or obj["property"]', 'obj->property', 'obj(property)', 'obj::property'],
              correctAnswerIndex: 0,
              explanation: 'Use dot notation or bracket notation to access properties.',
            ),
            QuizQuestion(
              question: 'What is "this" in an object method?',
              options: ['The global object', 'Undefined', 'The object itself', 'The window'],
              correctAnswerIndex: 2,
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Destructuring extracts properties: const {name, age} = person assigns person.name to name and person.age to age.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Object.keys() returns an array of an object\'s property names (keys). Object.values() returns the values.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'The spread operator {...obj} creates a shallow copy. Alternatively, use Object.assign({}, obj).',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Create a Product',
          description: 'Create an object "product" with name, price, and inStock properties. Log the name.',
          starterCode: '// Create product object\nconst product = {};\n',
          language: 'javascript',
          testCases: [
            TestCase(input: '', expectedOutput: 'Laptop'),
          ],
          hint: 'Use {key: value} syntax.',
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Functions are reusable blocks of code. JavaScript has multiple ways to define them.',
          ...
          TheorySlide(
            ...
            codeSnippet: 'const greet = (name = "Guest") => {\n  console.log("Welcome, " + name + "!");\n};\n\ngreet();          // Welcome, Guest!\ngreet("Alice");   // Welcome, Alice!',
            codeLanguage: 'javascript',
            order: 2,
          ),
          TheorySlide(
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              options: ['Filters an array', 'Transforms each element', 'Sorts an array', 'Reverses an array'],
              correctAnswerIndex: 1,
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'A closure is when a function "remembers" variables from its outer scope, even after that scope has finished executing!',
            ),
            QuizQuestion(
              question: 'What is the difference between function declarations and arrow functions regarding "this"?',
              options: [
                'No difference',
              ...
              correctAnswerIndex: 1,
              explanation: 'Arrow functions inherit "this" from their surrounding scope (lexical this). Regular functions create their own "this" context.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'reduce() executes a reducer function on each element, resulting in a single output value. Example: sum all numbers.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Square Numbers',
          description: 'Create an arrow function that takes a number and returns its square. Test with 8.',
          starterCode: '// Create square function\nconst square = \n\nconsole.log(square(8));',
          language: 'javascript',
          testCases: [
            TestCase(input: '', expectedOutput: '64'),
          ],
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Asynchronous code doesn\'t wait for operations to complete. It continues running and handles results later.\n\nCommon async operations:\n• Network requests\n• File reading\n• Database queries\n• Timers',
            order: 0,
          ),
          TheorySlide(
            title: 'Callbacks',
          ...
          TheorySlide(
            title: 'Promises',
            content: 'Modern way to handle async operations. A promise represents a future value.',
          ...
          TheorySlide(
            title: 'Async/Await',
            content: 'The cleanest syntax for async code. Makes it read like synchronous code.',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Stops time', 'Delays execution', 'Measures time', 'Loops forever'],
              correctAnswerIndex: 1,
              explanation: 'setTimeout() delays code execution by a specified time.',
            ),
            QuizQuestion(
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'await pauses async function execution until the promise resolves, making async code look synchronous. Only works inside async functions!',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'A Promise can be pending (initial), fulfilled (successful), or rejected (failed). Use .then() for fulfilled and .catch() for rejected.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Promise.all() runs multiple promises concurrently and resolves when ALL complete (or rejects if ANY fails). Great for parallel operations!',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Delayed Message',
          description: 'Use setTimeout to log "Hello from the future!" after 0 milliseconds.',
    ...
    return [
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'HTML (HyperText Markup Language) is the skeleton of every website. It defines the structure and content of web pages.\n\nHTML uses "tags" to mark up content:\n• <p> for paragraphs\n• <h1> for headings\n• <img> for images\n• <a> for links',
            order: 0,
          ),
          TheorySlide(
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'The <head> section contains metadata including the <title>, <meta> tags, and links to stylesheets.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: '<strong> (semantic) or <b> (visual) make text bold.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: '<strong> indicates semantic importance (for screen readers), while <b> is purely visual formatting.',
            ),
            QuizQuestion(
              question: 'Which tag creates a line break?',
              options: ['<break>', '<lb>', '<br>', '<newline>'],
              correctAnswerIndex: 2,
              explanation: '<br> creates a line break without starting a new paragraph.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Semantic HTML improves accessibility for screen readers and helps search engines understand your content structure.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          ...
          language: 'html',
          testCases: [
            TestCase(input: '', expectedOutput: 'important'),
          ],
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'The <a> tag creates hyperlinks. The href attribute specifies the destination:',
          ...
          TheorySlide(
            ...
            codeSnippet: '<img src="photo.jpg" alt="A beautiful photo">\n\n<!-- With size -->\n<img src="logo.png" alt="Logo" width="200" height="100">',
            codeLanguage: 'html',
            order: 1,
          ),
          TheorySlide(
            title: 'Image as Link',
            content: 'You can make an image clickable by wrapping it in a link:',
            codeSnippet: '<a href="https://example.com">\n  <img src="banner.jpg" alt="Click me!">\n</a>',
            codeLanguage: 'html',
            order: 2,
          ),
        ],
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'href (hypertext reference) specifies where the link goes.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'alt provides text description for screen readers and when image fails to load.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 0,
              explanation: 'The target="_blank" attribute opens links in a new browser tab or window.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'An absolute URL includes the full protocol (https://) and domain name.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'The alt attribute helps visually impaired users and search engines understand image content.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Create a Link',
          description: 'Create a link to https://flutter.dev with text "Flutter"',
          starterCode: '<!-- Create your link here -->\n',
          language: 'html',
          testCases: [
            TestCase(input: '', expectedOutput: 'Flutter'),
          ],
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'External CSS files are best for maintainability and reusability.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'CSS specificity determines which style rules apply when multiple rules target the same element. Inline > ID > Class > Element.',
            ),
            QuizQuestion(
              question: 'Which CSS selector has the highest specificity?',
              options: ['Element selector (p)', 'Class selector (.box)', 'ID selector (#header)', 'Inline style'],
              correctAnswerIndex: 3,
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 3,
              explanation: 'Cascading refers to how styles from multiple sources combine, inherit from parent to child, and override each other based on specificity.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          ...
          language: 'css',
          testCases: [
            TestCase(input: '', expectedOutput: 'red'),
          ],
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'RGB defines colors by mixing red, green, and blue values. HSL uses hue (color), saturation (intensity), and lightness, which is often more intuitive.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'linear-gradient() creates gradients. Without a direction, it defaults to top-to-bottom.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Style a Box',
          description: 'Create CSS for .box with white text and blue background.',
          starterCode: '/* Style the box class */\n',
          language: 'css',
          testCases: [
            TestCase(input: '', expectedOutput: 'blue'),
          ],
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            title: 'The Box Model 📦',
            content: 'Every HTML element is a box! The box model consists of:\n\n• Content - The actual text/image\n• Padding - Space around content\n• Border - Line around padding\n• Margin - Space outside border',
            order: 0,
          ),
          TheorySlide(
            title: 'Padding',
          ...
          TheorySlide(
            title: 'Margin',
            content: 'Margin creates space outside the element, separating it from other elements.',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Space outside element', 'Space inside element', 'Border width', 'Font size'],
              correctAnswerIndex: 1,
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'margin: 0 auto; sets top/bottom to 0 and left/right to auto, centering the element.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'By default, box-sizing is content-box, where width/height only apply to content. border-box includes padding and border in the dimensions.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'border-box makes width/height include padding and border, making sizing more predictable.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Margin collapse occurs when vertical margins of adjacent elements overlap, and the larger margin wins.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Style a Card',
          description: 'Create a CSS class called "card" with 20px padding, 10px margin, and a 1px solid gray border.',
          starterCode: '/* Style your card */\n.card {\n  \n}',
          language: 'css',
          testCases: [
            TestCase(input: '', expectedOutput: 'padding'),
          ],
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Flexbox is a powerful layout system that makes it easy to:\n\n• Align items horizontally or vertically\n• Distribute space between items\n• Create responsive layouts\n• Center content perfectly',
            order: 0,
          ),
          TheorySlide(
            title: 'Flex Container',
            content: 'Enable flexbox by setting display: flex on the parent container.',
          ...
          TheorySlide(
            ...
            content: 'Controls alignment along the main axis (horizontal by default).',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Set display: flex on the container element to enable Flexbox.',
            ),
            QuizQuestion(
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'flex-direction: column changes the main axis to vertical, making items stack from top to bottom.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'flex: 1 makes the item grow to fill available space, with a flex-grow factor of 1.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'flex-wrap: wrap allows flex items to wrap to multiple lines instead of shrinking or overflowing.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Center Everything',
          description: 'Create a flex container that centers its children both horizontally and vertically.',
          starterCode: '.center-box {\n  display: flex;\n  \n}',
          language: 'css',
          testCases: [
            TestCase(input: '', expectedOutput: 'justify-content'),
          ],
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'CSS Grid is perfect for 2D layouts with rows AND columns.\n\nUse cases:\n• Page layouts\n• Image galleries\n• Card grids\n• Dashboard layouts',
            order: 0,
          ),
          TheorySlide(
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['1 pixel', '1 percent', '1 fraction of available space', '1 row'],
              correctAnswerIndex: 2,
              explanation: 'fr is a fractional unit that divides available space proportionally.',
            ),
            QuizQuestion(
              question: 'How do you create 4 equal columns?',
              options: ['grid-columns: 4', 'grid-template-columns: repeat(4, 1fr)', 'columns: 4', 'grid: 4-col'],
              correctAnswerIndex: 1,
              explanation: 'repeat(4, 1fr) creates 4 columns, each taking 1 fraction of space.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'The gap property (or grid-gap) sets spacing between rows and columns in a grid layout.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'grid-column: 1 / 3 makes the item span from grid line 1 to line 3, covering 2 columns.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Use Grid for 2D layouts where you need control over both rows and columns. Use Flexbox for simpler 1D layouts.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Create a Grid',
          description: 'Create a grid with 3 equal columns and 20px gap between items.',
          starterCode: '.gallery {\n  display: grid;\n  \n}',
          language: 'css',
          testCases: [
            TestCase(input: '', expectedOutput: 'repeat'),
          ],
      ...
      Lesson(
        ...
        theorySlides: [
          ...
          TheorySlide(
            ...
            codeSnippet: '/* Default styles for mobile */\n.container {\n  width: 100%;\n}\n\n/* Styles for tablets and up */\n@media (min-width: 768px) {\n  .container {\n    width: 750px;\n  }\n}\n\n/* Styles for desktop */\n@media (min-width: 1200px) {\n  .container {\n    width: 1140px;\n  }\n}',
            codeLanguage: 'css',
            order: 2,
          ),
          TheorySlide(
            title: 'Mobile-First Approach',
            content: 'Start with mobile styles, then add complexity for larger screens.',
            codeSnippet: '/* Mobile-first: single column */\n.grid {\n  display: flex;\n  flex-direction: column;\n}\n\n/* Tablet: 2 columns */\n@media (min-width: 768px) {\n  .grid {\n    flex-direction: row;\n    flex-wrap: wrap;\n  }\n  .item { width: 50%; }\n}',
            codeLanguage: 'css',
            order: 3,
          ),
        ],
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Makes text bigger', 'Controls page width on mobile', 'Adds animations', 'Changes colors'],
              correctAnswerIndex: 1,
              explanation: 'The viewport meta tag tells mobile browsers how to render the page width.',
            ),
            QuizQuestion(
              question: 'What is the mobile-first approach?',
              options: ['Only support mobile', 'Design mobile last', 'Start with mobile, add for larger screens', 'Ignore mobile'],
              correctAnswerIndex: 2,
              explanation: 'Mobile-first means writing base styles for mobile, then using media queries to enhance for larger screens.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: '@media (min-width: 768px) means "apply these styles when the viewport is 768px or wider".',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Common breakpoints target mobile (~480px), tablet (~768px), and desktop (~1024px+) devices.',
            ),
            QuizQuestion(
              question: 'Why use relative units (%, em, rem) instead of pixels for responsive design?',
              options: [
                'They look cooler',
              ...
              correctAnswerIndex: 1,
              explanation: 'Relative units scale proportionally and respect user accessibility settings, making designs more flexible and accessible.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Write a Media Query',
          description: 'Write a media query that changes .box width to 500px on screens 768px or wider.',
          starterCode: '.box {\n  width: 100%;\n}\n\n/* Add media query below */\n',
          language: 'css',
          testCases: [
            TestCase(input: '', expectedOutput: '@media'),
          ],
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Transitions smoothly animate changes between two states.\n\nUse for:\n• Hover effects\n• Focus states\n• Color changes\n• Size changes',
            order: 0,
          ),
          TheorySlide(
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Transitions animate between two states, while animations use @keyframes for complex multi-step sequences.',
            ),
            QuizQuestion(
              question: 'What does "infinite" do in animation-iteration-count?',
              options: ['Run once', 'Run twice', 'Loop forever', 'Stop animation'],
              correctAnswerIndex: 2,
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'animation-timing-function (ease, linear, ease-in, ease-out, etc.) controls how the animation progresses over time.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Use transitions for simple state changes (hover effects). Use @keyframes animations for multi-step, complex motion.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'forwards makes the element retain the styles from the last keyframe after the animation completes.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Add a Hover Effect',
          description: 'Make a button that smoothly changes background color on hover over 0.3 seconds.',
          starterCode: '.button {\n  background: #3498db;\n  color: white;\n  padding: 10px 20px;\n  /* Add transition */\n}\n\n.button:hover {\n  background: #2980b9;\n}',
          language: 'css',
          testCases: [
            TestCase(input: '', expectedOutput: 'transition'),
          ],
  ...
  static List<Lesson> getReactLessons() {
    return [
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'React is a JavaScript library for building user interfaces. Created by Facebook, it lets you build complex UIs from small, reusable pieces called components.\n\nWhy React?\n• Component-based architecture\n• Virtual DOM for fast updates\n• Large ecosystem and community\n• Used by Facebook, Netflix, Instagram',
            order: 0,
          ),
          TheorySlide(
          ...
          TheorySlide(
            ...
            content: 'Components are reusable pieces of UI. Start with a simple function:',
            codeSnippet: 'function Button() {\n  return <button>Click me!</button>;\n}\n\n// Use it in your app\nfunction App() {\n  return (\n    <div>\n      <h1>My App</h1>\n      <Button />\n    </div>\n  );\n}',
            codeLanguage: 'javascript',
            order: 2,
          ),
        ],
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'React is a JavaScript library specifically designed for building user interfaces, not a full framework or language.',
            ),
            QuizQuestion(
              question: 'What does JSX stand for?',
              options: ['Java Syntax Extension', 'JavaScript XML', 'JSON Syntax', 'Just Simple X'],
              correctAnswerIndex: 1,
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'In JSX, curly braces {} are used to embed JavaScript expressions, like {name} or {2 + 2}.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'A React component is a reusable piece of UI that can be combined with other components to build complex interfaces.',
            ),
            QuizQuestion(
              question: 'Which company created React?',
              options: ['Google', 'Microsoft', 'Facebook', 'Apple'],
              correctAnswerIndex: 2,
              explanation: 'React was created by Facebook (now Meta) and is used in many of their products.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Create a Greeting Component',
          description: 'Create a function component that returns an h1 element with the text "Hello, React!"',
          starterCode: 'function Greeting() {\n  // Your code here\n}\n',
          language: 'javascript',
          testCases: [
            TestCase(input: '', expectedOutput: 'Hello, React!'),
          ],
      ...
      Lesson(
        ...
        theorySlides: [
          ...
          TheorySlide(
            ...
            codeSnippet: 'function Avatar({ src, name }) {\n  return <img src={src} alt={name} />;\n}\n\nfunction UserCard({ user }) {\n  return (\n    <div className="card">\n      <Avatar src={user.avatar} name={user.name} />\n      <h2>{user.name}</h2>\n      <p>{user.email}</p>\n    </div>\n  );\n}',
            codeLanguage: 'javascript',
            order: 2,
          ),
        ],
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 0,
              explanation: 'Props are properties passed from parent to child components to share data.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Props are read-only. Components must never modify their own props - they should act like pure functions.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Non-string values must be passed in curly braces: {25} for numbers, {true} for booleans, etc.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Component composition is the practice of building complex UIs by combining simpler, reusable components.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Create a User Card',
          description: 'Create a UserCard component that accepts name and email props and displays them in a div.',
          starterCode: 'function UserCard({ name, email }) {\n  // Your code here\n}\n',
          language: 'javascript',
          testCases: [
            TestCase(input: 'name="Alice",email="alice@example.com"', expectedOutput: 'Alice'),
          ],
      ...
      Lesson(
        ...
        description: 'Learn useState hook, state updates, and controlled components',
        theorySlides: [
          TheorySlide(
            title: 'Understanding State 🔄',
            content: 'State is data that changes over time. Unlike props, state is managed within the component.\n\nWhen state changes:\n• React re-renders the component\n• UI updates automatically\n• User interactions can modify state\n\nUse the useState hook to add state!',
            order: 0,
          ),
          TheorySlide(
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'State is data managed within a component that can change over time, triggering re-renders when updated.',
            ),
            QuizQuestion(
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Always use the setState function returned by useState. Never modify state directly.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'A controlled component is a form input whose value is controlled by React state via value and onChange props.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'When state updates, React re-renders the component to reflect the new state in the UI.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Create a Toggle Button',
          description: 'Create a component with a button that toggles between "ON" and "OFF" using useState.',
          starterCode: 'import { useState } from "react";\n\nfunction Toggle() {\n  // Your code here\n}\n',
          language: 'javascript',
          testCases: [
            TestCase(input: '', expectedOutput: 'ON'),
          ],
          hint: 'Use useState with a boolean value and toggle it on button click.',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'React uses camelCase (onClick) and expects a function reference, not a string.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'e.preventDefault() stops the default form submission behavior which would reload the page.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Wrap the function call in an arrow function to pass parameters: onClick={() => handleClick(param)}',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'The event object provides details about the event, including the target element, event type, and helpful methods.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Create a Form with Submit Handler',
          description: 'Create a form that captures a name input and logs it on submit. Use e.preventDefault().',
          starterCode: 'import { useState } from "react";\n\nfunction NameForm() {\n  const [name, setName] = useState("");\n  // Your code here\n}\n',
          language: 'javascript',
          testCases: [
            TestCase(input: '', expectedOutput: 'form'),
          ],
          hint: 'Create a form with onSubmit handler that prevents default and an input with onChange.',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: '.map() transforms an array into a new array of JSX elements, making it perfect for rendering lists.',
            ),
            QuizQuestion(
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'Good keys are stable and unique identifiers like database IDs, not array indices which can change.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'Index can be used as a last resort for static lists that won\'t reorder, but unique IDs are always better.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Keys only need to be unique among siblings (items in the same list), not globally across the app.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Render a List of Names',
          description: 'Create a component that renders a ul with list items for each name in the array.',
          starterCode: 'function NameList() {\n  const names = ["Alice", "Bob", "Charlie"];\n  // Your code here\n}\n',
          language: 'javascript',
          testCases: [
            TestCase(input: '', expectedOutput: 'Alice'),
          ],
          hint: 'Use .map() to transform the names array into <li> elements with keys.',
          solution: 'function NameList() {\n  const names = ["Alice", "Bob", "Charlie"];\n  return (\n    <ul>\n      {names.map((name, index) => (\n        <li key={index}>{name}</li>\n      ))}\n    </ul>\n  );\n}',
        ),
        xpReward: 20,
        order: 4,
      ),
      ...
      Lesson(
        ...
        description: 'Learn ternary operators, && operator, and multiple conditions',
        theorySlides: [
          TheorySlide(
            title: 'Conditional Rendering 🔀',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'The ternary operator follows the pattern: condition ? valueIfTrue : valueIfFalse',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Use && when you want to show something only if a condition is true, otherwise show nothing.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Early returns exit the function before reaching the end, useful for handling edge cases first.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'If statements can\'t be used directly in JSX. Use ternary operators, &&, or define variables outside JSX.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Conditional Welcome Message',
          description: 'Create a component that shows "Welcome!" if isLoggedIn is true, otherwise show "Please log in".',
          starterCode: 'function WelcomeMessage({ isLoggedIn }) {\n  // Your code here\n}\n',
          language: 'javascript',
          testCases: [
            TestCase(input: 'isLoggedIn=true', expectedOutput: 'Welcome!'),
          ],
          hint: 'Use a ternary operator: isLoggedIn ? "Welcome!" : "Please log in"',
          solution: 'function WelcomeMessage({ isLoggedIn }) {\n  return (\n    <div>\n      {isLoggedIn ? <p>Welcome!</p> : <p>Please log in</p>}\n    </div>\n  );\n}',
        ),
        xpReward: 20,
        order: 5,
      ),
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Side effects are operations that reach outside your component:\n\n• Fetching data from APIs\n• Setting up subscriptions\n• Manually changing the DOM\n• Setting timers\n\nuseEffect runs after render, keeping your component pure!',
            order: 0,
          ),
          TheorySlide(
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Side effects are operations that interact with systems outside the component, like APIs, timers, or subscriptions.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'useEffect runs after the render is committed to the screen, keeping the render phase pure.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'An empty dependency array means the effect runs once when the component mounts, like componentDidMount.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'The cleanup function removes side effects when the component unmounts or before the effect runs again.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Missing dependencies can cause your effect to use stale values. Always include values your effect depends on.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Fetch Data on Mount',
          description: 'Create a component that logs "Data fetched" once when it mounts using useEffect.',
          starterCode: 'import { useEffect } from "react";\n\nfunction DataFetcher() {\n  // Your code here\n}\n',
          language: 'javascript',
          testCases: [
            TestCase(input: '', expectedOutput: 'Data fetched'),
          ],
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Breaking apps into components improves reusability, maintainability, and makes code easier to understand.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Use the spread operator to create a new array: setTodos([...todos, newItem]). Never mutate state directly.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Date.now() returns the current timestamp in milliseconds, making it useful for generating simple unique IDs.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Use .map() to iterate and conditionally update the specific item, creating a new array without mutating state.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Create a Simple Todo App',
          description: 'Build a basic todo app with add functionality. Display todos in a list.',
          starterCode: 'import { useState } from "react";\n\nfunction TodoApp() {\n  const [todos, setTodos] = useState([]);\n  const [input, setInput] = useState("");\n  // Your code here\n}\n',
          language: 'javascript',
          testCases: [
            TestCase(input: '', expectedOutput: 'todo'),
          ],
          hint: 'Create input, button, and list. Use state to manage todos array and input value.',
    ...
    return [
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            title: 'What is SQL? 🗄️',
            content: 'SQL (Structured Query Language) is the standard language for working with databases. It\'s used by millions of applications worldwide to store, retrieve, and manage data.\n\nSQL allows you to:\n• Store data in organized tables\n• Retrieve exactly the data you need\n• Update and delete information\n• Create complex reports and analysis',
            order: 0,
          ),
          TheorySlide(
            title: 'Understanding Databases',
            content: 'A database is like a digital filing cabinet. It contains tables, which are like spreadsheets with rows and columns.\n\n📊 Table Example: "users"\n┌────┬──────────┬─────────────────┐\n│ id │ name     │ email           │\n├────┼──────────┼─────────────────┤\n│ 1  │ Alice    │ alice@email.com │\n│ 2  │ Bob      │ bob@email.com   │\n└────┴──────────┴─────────────────┘\n\nEach row is a record, each column is a field.',
            order: 1,
          ),
          TheorySlide(
            title: 'Your First SELECT Query',
            content: 'The SELECT statement retrieves data from a database. It\'s the most common SQL command you\'ll use.',
            codeSnippet: '-- Get all data from the users table\nSELECT * FROM users;\n\n-- Get only names from the users table\nSELECT name FROM users;\n\n-- Get multiple columns\nSELECT name, email FROM users;',
            codeLanguage: 'sql',
            order: 2,
          ),
        ],
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'SQL stands for Structured Query Language. It\'s the standard language for managing and querying relational databases.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'The asterisk (*) is a wildcard that means "all columns". SELECT * retrieves every column from the specified table.',
            ),
            QuizQuestion(
              question: 'In a database table, what is a row called?',
              options: ['A field', 'A column', 'A record', 'A query'],
              correctAnswerIndex: 2,
              explanation: 'Each row in a table is called a record. It represents a single entry with values for each column.',
            ),
            QuizQuestion(
              question: 'Which keyword is used to specify which table to query?',
              options: ['GET', 'FROM', 'TABLE', 'WHERE'],
              correctAnswerIndex: 1,
              explanation: 'The FROM keyword specifies which table to retrieve data from. Example: SELECT name FROM users.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'SQL is specifically designed to manage and query relational databases, allowing you to store, retrieve, update, and delete data.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          ...
          hint: 'Use SELECT * to get all columns, and FROM to specify the table name.',
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Instead of selecting everything with *, you can choose exactly which columns you need. This is more efficient and makes your queries clearer.',
            codeSnippet: '-- Select specific columns\nSELECT name, price FROM products;\n\n-- Select with a different order\nSELECT price, name, category FROM products;\n\n-- Columns can be listed in any order you want',
            codeLanguage: 'sql',
            order: 0,
          ),
          TheorySlide(
            title: 'Filtering with WHERE',
            content: 'The WHERE clause filters results to show only rows that match a condition. It\'s like asking "show me only the items that..."',
            codeSnippet: '-- Find products with price greater than 50\nSELECT name, price FROM products\nWHERE price > 50;\n\n-- Find a specific user by name\nSELECT * FROM users\nWHERE name = \'Alice\';\n\n-- Find products in a specific category\nSELECT * FROM products\nWHERE category = \'Electronics\';',
            codeLanguage: 'sql',
            order: 1,
          ),
          TheorySlide(
            title: 'Comparison Operators',
            content: 'SQL supports various operators for comparing values:\n\n• = Equal to\n• != or <> Not equal to\n• > Greater than\n• < Less than\n• >= Greater than or equal\n• <= Less than or equal',
            codeSnippet: '-- Find products priced at exactly 29.99\nSELECT * FROM products WHERE price = 29.99;\n\n-- Find orders with quantity less than 10\nSELECT * FROM orders WHERE quantity < 10;\n\n-- Find users who are NOT admins\nSELECT * FROM users WHERE role != \'admin\';',
            codeLanguage: 'sql',
            order: 2,
          ),
        ],
        quiz: Quiz(
          questions: [
            QuizQuestion(
              question: 'How do you select only the "name" and "email" columns from a "users" table?',
              options: [
                'SELECT * FROM users;',
                'SELECT name, email FROM users;',
              ...
              correctAnswerIndex: 1,
              explanation: 'List the column names separated by commas after SELECT: SELECT name, email FROM users;',
            ),
            QuizQuestion(
              question: 'Which keyword is used to filter results?',
              options: ['FILTER', 'WHEN', 'WHERE', 'IF'],
              correctAnswerIndex: 2,
              explanation: 'The WHERE clause is used to filter records that match a specific condition.',
            ),
            QuizQuestion(
              question: 'How do you find products where price is greater than 100?',
              options: [
            ...
            QuizQuestion(
              ...
              options: ['==', '!==', '!= or <>', '=/='],
              correctAnswerIndex: 2,
              explanation: 'In SQL, both != and <> mean "not equal to". Both are valid and widely used.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'In SQL, text (string) values should be enclosed in single quotes, like \'Alice\' or \'Electronics\'.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Filter Products',
          description: 'Write a query to select the name and price of all products where the price is less than or equal to 50.',
          starterCode: '-- Get name and price for affordable products\n',
          language: 'sql',
          testCases: [
            TestCase(input: '', expectedOutput: 'SELECT name, price FROM products WHERE price <= 50;'),
          ],
          hint: 'Use SELECT to choose columns, FROM for the table, and WHERE with <= for the condition.',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'AND requires ALL conditions to be true. If any condition is false, the row is not selected.',
            ),
            QuizQuestion(
              question: 'Which is the correct way to match values 10, 20, or 30?',
              options: [
              ...
              correctAnswerIndex: 1,
              explanation: 'IN allows you to specify multiple values: WHERE value IN (10, 20, 30). Note that BETWEEN would include all numbers from 10 to 30, not just 10, 20, and 30.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'The % wildcard matches zero or more characters of any type. For example, \'A%\' matches \'A\', \'Alice\', and \'Amazing\'.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 0,
              explanation: 'Use NOT LIKE to negate a pattern match: WHERE name NOT LIKE \'J%\'',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'BETWEEN is inclusive, meaning it includes both the start and end values. BETWEEN 5 AND 10 includes 5, 6, 7, 8, 9, and 10.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Complex Filter',
          description: 'Write a query to find all users whose name starts with \'J\' AND whose email contains \'gmail\'.',
          starterCode: '-- Find users with specific name and email patterns\n',
          language: 'sql',
          testCases: [
            TestCase(input: '', expectedOutput: 'SELECT * FROM users WHERE name LIKE \'J%\' AND email LIKE \'%gmail%\';'),
          ],
          hint: 'Use LIKE with % wildcard for pattern matching. Combine conditions with AND.',
          solution: 'SELECT * FROM users WHERE name LIKE \'J%\' AND email LIKE \'%gmail%\';',
        ),
        xpReward: 20,
        order: 2,
      ),
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'DESC (descending) sorts from highest to lowest. ASC (ascending) sorts from lowest to highest.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'LIMIT 5 restricts the result set to only the first 5 rows returned by the query.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'NULL requires the IS operator, not =. Use WHERE column IS NULL or WHERE column IS NOT NULL.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'OFFSET 10 skips the first 10 rows. Combined with LIMIT 5, you get rows 11-15.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 0,
              explanation: 'Sort by price in ascending order (lowest first) and limit to 3 results.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Top Products',
          description: 'Write a query to get the 5 most expensive products. Show only the name and price columns, sorted by price from highest to lowest.',
          starterCode: '-- Get the top 5 expensive products\n',
          language: 'sql',
          testCases: [
            TestCase(input: '', expectedOutput: 'SELECT name, price FROM products ORDER BY price DESC LIMIT 5;'),
          ],
          hint: 'Use ORDER BY with DESC for highest first, then LIMIT to restrict results.',
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Aggregate functions perform calculations on multiple rows and return a single value. They\'re essential for data analysis and reporting.\n\n• COUNT() - Number of rows\n• SUM() - Total of values\n• AVG() - Average of values\n• MIN() - Smallest value\n• MAX() - Largest value',
            order: 0,
          ),
          TheorySlide(
            title: 'COUNT, SUM, and AVG',
            content: 'These are the most commonly used aggregate functions:',
            codeSnippet: '-- Count total number of products\nSELECT COUNT(*) FROM products;\n\n-- Count products in a category\nSELECT COUNT(*) FROM products\nWHERE category = \'Electronics\';\n\n-- Sum of all order amounts\nSELECT SUM(amount) FROM orders;\n\n-- Average product price\nSELECT AVG(price) FROM products;\n\n-- Count non-NULL emails\nSELECT COUNT(email) FROM users;',
            codeLanguage: 'sql',
            order: 1,
          ),
          TheorySlide(
            title: 'MIN, MAX, and Column Aliases',
            content: 'Find extreme values and give your results meaningful names:',
            codeSnippet: '-- Find the cheapest product price\nSELECT MIN(price) AS lowest_price FROM products;\n\n-- Find the most expensive product price  \nSELECT MAX(price) AS highest_price FROM products;\n\n-- Combine multiple aggregates\nSELECT \n  COUNT(*) AS total_products,\n  AVG(price) AS average_price,\n  MIN(price) AS min_price,\n  MAX(price) AS max_price\nFROM products;',
            codeLanguage: 'sql',
            order: 2,
          ),
        ],
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'COUNT(*) counts all rows, while COUNT(column) only counts rows where that specific column is not NULL.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'AVG() is the standard SQL function for calculating averages. While option D would work mathematically, AVG() is cleaner and handles NULLs correctly.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'AS creates an alias, giving the result column a custom name. "AS total" means the count will appear in a column named "total".',
            ),
            QuizQuestion(
              question: 'Which function finds the highest value?',
              options: ['TOP()', 'HIGHEST()', 'MAX()', 'GREATEST()'],
              correctAnswerIndex: 2,
              explanation: 'MAX() returns the maximum (highest) value in a column. It works with numbers, dates, and text.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Order Statistics',
          description: 'Write a query that shows the total number of orders, the sum of all amounts, and the average amount from the "orders" table. Use aliases: total_orders, total_amount, avg_amount.',
          starterCode: '-- Calculate order statistics\n',
          language: 'sql',
          testCases: [
            TestCase(input: '', expectedOutput: 'SELECT COUNT(*) AS total_orders, SUM(amount) AS total_amount, AVG(amount) AS avg_amount FROM orders;'),
          ],
          hint: 'Use COUNT(*), SUM(), and AVG() with AS to create aliases for each result.',
          solution: 'SELECT COUNT(*) AS total_orders, SUM(amount) AS total_amount, AVG(amount) AS avg_amount FROM orders;',
        ),
        xpReward: 20,
        order: 4,
      ),
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'GROUP BY divides rows into groups based on column values, allowing you to apply aggregate functions to each group separately.',
            codeSnippet: '-- Count products per category\nSELECT category, COUNT(*) AS product_count\nFROM products\nGROUP BY category;\n\n-- Total sales per customer\nSELECT customer_id, SUM(amount) AS total_spent\nFROM orders\nGROUP BY customer_id;\n\n-- Average price by category\nSELECT category, AVG(price) AS avg_price\nFROM products\nGROUP BY category;',
            codeLanguage: 'sql',
            order: 0,
          ),
          TheorySlide(
            title: 'Filtering Groups with HAVING',
            content: 'HAVING filters groups AFTER aggregation. Use it when you want to filter based on aggregate results (WHERE can\'t do this!).',
            codeSnippet: '-- Categories with more than 10 products\nSELECT category, COUNT(*) AS count\nFROM products\nGROUP BY category\nHAVING COUNT(*) > 10;\n\n-- Customers who spent over \$1000\nSELECT customer_id, SUM(amount) AS total\nFROM orders\nGROUP BY customer_id\nHAVING SUM(amount) > 1000;\n\n-- WHERE filters rows, HAVING filters groups\nSELECT category, AVG(price) AS avg_price\nFROM products\nWHERE price > 0        -- Filter rows first\nGROUP BY category\nHAVING AVG(price) > 50; -- Then filter groups',
            codeLanguage: 'sql',
            order: 1,
          ),
          TheorySlide(
            ...
            codeSnippet: '-- Sales report by category and month\nSELECT \n  category,\n  COUNT(*) AS num_orders,\n  SUM(amount) AS total_sales,\n  AVG(amount) AS avg_order\nFROM orders\nWHERE status = \'completed\'\nGROUP BY category\nHAVING SUM(amount) >= 1000\nORDER BY total_sales DESC;\n\n-- Query execution order:\n-- 1. FROM (get table)\n-- 2. WHERE (filter rows)\n-- 3. GROUP BY (create groups)\n-- 4. HAVING (filter groups)\n-- 5. SELECT (choose columns)\n-- 6. ORDER BY (sort results)',
            codeLanguage: 'sql',
            order: 2,
          ),
        ],
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'GROUP BY divides rows into groups based on one or more columns, so aggregate functions can be applied to each group separately.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'WHERE filters individual rows before they are grouped. HAVING filters groups after aggregation. Use HAVING when filtering on aggregate results like COUNT() or SUM().',
            ),
            QuizQuestion(
              question: 'Which query finds categories with average price over \$50?',
              options: [
              ...
              correctAnswerIndex: 1,
              explanation: 'You must use HAVING (not WHERE) to filter on aggregate functions. HAVING comes after GROUP BY.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'In a GROUP BY query, SELECT can only include columns that are in the GROUP BY clause, or columns wrapped in aggregate functions.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'SQL executes in this order: FROM (get data) → WHERE (filter rows) → GROUP BY (group) → HAVING (filter groups) → SELECT (columns) → ORDER BY (sort)',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Category Analysis',
          description: 'Write a query to show each category and its product count from the "products" table. Only include categories that have more than 5 products. Order by count descending.',
          starterCode: '-- Show categories with more than 5 products\n',
          language: 'sql',
          testCases: [
            TestCase(input: '', expectedOutput: 'SELECT category, COUNT(*) AS product_count FROM products GROUP BY category HAVING COUNT(*) > 5 ORDER BY product_count DESC;'),
          ],
          hint: 'GROUP BY category, use HAVING to filter groups with COUNT(*) > 5, then ORDER BY.',
          solution: 'SELECT category, COUNT(*) AS product_count FROM products GROUP BY category HAVING COUNT(*) > 5 ORDER BY product_count DESC;',
        ),
        xpReward: 22,
        order: 5,
      ),
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            title: 'Why Use JOINs? 🔗',
            content: 'Real databases split data across multiple tables to avoid duplication. JOINs let you combine related data from different tables.\n\nExample Tables:\n• users: id, name, email\n• orders: id, user_id, amount, date\n\nThe user_id in orders links to id in users. This relationship lets us see which user made each order.',
            order: 0,
          ),
          TheorySlide(
            title: 'INNER JOIN',
            content: 'INNER JOIN returns only rows that have matching values in both tables. It\'s the most common type of join.',
            codeSnippet: '-- Get orders with customer names\nSELECT orders.id, users.name, orders.amount\nFROM orders\nINNER JOIN users ON orders.user_id = users.id;\n\n-- Using table aliases for cleaner code\nSELECT o.id, u.name, o.amount\nFROM orders o\nINNER JOIN users u ON o.user_id = u.id;\n\n-- With additional filtering\nSELECT u.name, o.amount, o.order_date\nFROM orders o\nINNER JOIN users u ON o.user_id = u.id\nWHERE o.amount > 100;',
            codeLanguage: 'sql',
            order: 1,
          ),
          TheorySlide(
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'The ON clause defines the relationship between tables by specifying which columns should match (e.g., orders.user_id = users.id).',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'A table alias is a temporary short name (like "u" for "users") that makes queries easier to write and read.',
            ),
            QuizQuestion(
              question: 'If orders has 100 rows and users has 50, how many rows could INNER JOIN return maximum?',
              options: [
                'Exactly 100',
                'Exactly 50',
              ...
              correctAnswerIndex: 2,
              explanation: 'INNER JOIN returns only matching rows. If all 100 orders have valid user_ids that exist in users, you get 100 rows. Unmatched rows are excluded.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'In SQL, JOIN without a prefix defaults to INNER JOIN. They produce the same results.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Join Orders with Users',
          description: 'Write a query to show each order with the customer\'s name. Select the order id, user name, and amount. Use table aliases (o for orders, u for users).',
          starterCode: '-- Join orders with users to see customer names\n',
          language: 'sql',
          testCases: [
            TestCase(input: '', expectedOutput: 'SELECT o.id, u.name, o.amount FROM orders o INNER JOIN users u ON o.user_id = u.id;'),
          ],
          hint: 'Use FROM orders o, then INNER JOIN users u ON o.user_id = u.id',
          solution: 'SELECT o.id, u.name, o.amount FROM orders o INNER JOIN users u ON o.user_id = u.id;',
        ),
        xpReward: 22,
        order: 6,
      ),
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'LEFT JOIN returns all rows from the left table, plus matching rows from the right table. If there\'s no match, NULL values fill in for the right table columns.',
            codeSnippet: '-- All users, even those with no orders\nSELECT u.name, o.amount\nFROM users u\nLEFT JOIN orders o ON u.id = o.user_id;\n\n-- Result might include:\n-- Alice  | 99.99\n-- Bob    | 150.00\n-- Carol  | NULL    ← Carol has no orders\n\n-- Find users who have never ordered\nSELECT u.name, u.email\nFROM users u\nLEFT JOIN orders o ON u.id = o.user_id\nWHERE o.id IS NULL;',
            codeLanguage: 'sql',
            order: 0,
          ),
          TheorySlide(
            title: 'RIGHT JOIN & Visual Guide',
            content: 'RIGHT JOIN is the opposite of LEFT - it keeps all rows from the right table.\n\n📊 JOIN Types Visual:\n\nINNER: Only matching rows (A ∩ B)\nLEFT:  All from left + matches (A + A∩B)\nRIGHT: All from right + matches (B + A∩B)',
            codeSnippet: '-- All products, even those never ordered\nSELECT p.name, o.quantity\nFROM order_items o\nRIGHT JOIN products p ON o.product_id = p.id;\n\n-- RIGHT JOIN is less common - you can usually\n-- rewrite it as LEFT JOIN by swapping tables:\nSELECT p.name, o.quantity\nFROM products p\nLEFT JOIN order_items o ON p.id = o.product_id;',
            codeLanguage: 'sql',
            order: 1,
          ),
          TheorySlide(
            title: 'Joining Multiple Tables',
            content: 'You can chain multiple JOINs to combine data from several related tables:',
            codeSnippet: '-- Orders with user names and product details\nSELECT \n  u.name AS customer,\n  p.name AS product,\n  oi.quantity,\n  o.order_date\nFROM orders o\nINNER JOIN users u ON o.user_id = u.id\nINNER JOIN order_items oi ON o.id = oi.order_id\nINNER JOIN products p ON oi.product_id = p.id\nWHERE o.order_date >= \'2024-01-01\';\n\n-- Mix JOIN types as needed\nSELECT u.name, COUNT(o.id) AS order_count\nFROM users u\nLEFT JOIN orders o ON u.id = o.user_id\nGROUP BY u.id, u.name;',
            codeLanguage: 'sql',
            order: 2,
          ),
        ],
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'LEFT JOIN includes all rows from the left table, even if there\'s no match in the right table. Unmatched right columns show as NULL.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Use LEFT JOIN and check for NULL in the right table\'s key column. If orders.id IS NULL, the user has no matching orders.',
            ),
            QuizQuestion(
              question: 'If users has 100 rows and orders has 50, what\'s the minimum LEFT JOIN result?',
              options: [
                '50 rows',
                '100 rows',
                '150 rows',
              ...
              correctAnswerIndex: 1,
              explanation: 'LEFT JOIN always returns at least as many rows as the left table. All 100 users will appear, even those without orders.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'You can chain multiple JOINs to combine data from many tables. Each JOIN adds another table to the result.',
            ),
            QuizQuestion(
              question: 'RIGHT JOIN users ON orders.user_id = users.id is equivalent to:',
              options: [
              ...
              correctAnswerIndex: 0,
              explanation: 'RIGHT JOIN table_a is equivalent to LEFT JOIN with the tables swapped. Most developers prefer LEFT JOIN for consistency.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Find Inactive Users',
          description: 'Write a query to find all users who have never placed an order. Use LEFT JOIN and check for NULL. Show only the user name and email.',
          starterCode: '-- Find users with no orders\n',
          language: 'sql',
          testCases: [
            TestCase(input: '', expectedOutput: 'SELECT u.name, u.email FROM users u LEFT JOIN orders o ON u.id = o.user_id WHERE o.id IS NULL;'),
          ],
          hint: 'LEFT JOIN keeps all users. Where there\'s no matching order, order columns will be NULL.',
          solution: 'SELECT u.name, u.email FROM users u LEFT JOIN orders o ON u.id = o.user_id WHERE o.id IS NULL;',
        ),
        xpReward: 23,
        order: 7,
      ),
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 2,
              explanation: 'The correct syntax is INSERT INTO table (columns) VALUES (values);',
            ),
            QuizQuestion(
              question: 'What happens if you run UPDATE users SET status = \'active\'; without WHERE?',
              options: [
              ...
              correctAnswerIndex: 2,
              explanation: 'Without a WHERE clause, UPDATE affects ALL rows in the table. This is a common and dangerous mistake!',
            ),
            QuizQuestion(
              question: 'How do you change a product\'s price from \$100 to \$90?',
              options: [
              ...
              correctAnswerIndex: 0,
              explanation: 'Use UPDATE table SET column = value WHERE condition; to modify specific rows.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Always preview what will be deleted by running a SELECT with the same WHERE clause first. This prevents accidental data loss.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'ROLLBACK undoes all changes made since the transaction began. COMMIT saves them. Transactions let you test changes safely.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Add a New Product',
          description: 'Write an INSERT statement to add a new product with name "Wireless Mouse", price 29.99, and category "Electronics" to the products table.',
          starterCode: '-- Insert a new product\n',
          language: 'sql',
          testCases: [
            TestCase(input: '', expectedOutput: 'INSERT INTO products (name, price, category) VALUES (\'Wireless Mouse\', 29.99, \'Electronics\');'),
          ],
          hint: 'Use INSERT INTO table (columns) VALUES (values); - remember to quote text values.',
          solution: 'INSERT INTO products (name, price, category) VALUES (\'Wireless Mouse\', 29.99, \'Electronics\');',
        ),
        xpReward: 23,
        order: 8,
      ),
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'CREATE TABLE defines a new table with columns and their data types. Each column needs a name and type.',
            codeSnippet: '-- Basic table creation\nCREATE TABLE users (\n  id INT,\n  name VARCHAR(100),\n  email VARCHAR(255),\n  age INT,\n  created_at TIMESTAMP\n);\n\n-- Common data types:\n-- INT: Whole numbers (1, 42, -10)\n-- DECIMAL(10,2): Decimal numbers (99.99)\n-- VARCHAR(n): Text up to n characters\n-- TEXT: Long text (no limit)\n-- BOOLEAN: true/false\n-- DATE: Dates (2024-01-15)\n-- TIMESTAMP: Date + time',
            codeLanguage: 'sql',
            order: 0,
          ),
          TheorySlide(
            title: 'Primary Keys & Auto Increment',
            content: 'A PRIMARY KEY uniquely identifies each row. AUTO_INCREMENT generates unique IDs automatically.',
            codeSnippet: '-- Table with primary key and auto-increment\nCREATE TABLE products (\n  id INT PRIMARY KEY AUTO_INCREMENT,\n  name VARCHAR(255) NOT NULL,\n  price DECIMAL(10, 2) NOT NULL,\n  description TEXT,\n  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP\n);\n\n-- PostgreSQL uses SERIAL instead:\nCREATE TABLE products (\n  id SERIAL PRIMARY KEY,\n  name VARCHAR(255) NOT NULL,\n  price DECIMAL(10, 2) NOT NULL\n);',
            codeLanguage: 'sql',
            order: 1,
          ),
          TheorySlide(
            title: 'Constraints & Foreign Keys',
            content: 'Constraints enforce rules on your data to maintain integrity:',
            codeSnippet: '-- Table with various constraints\nCREATE TABLE orders (\n  id INT PRIMARY KEY AUTO_INCREMENT,\n  user_id INT NOT NULL,\n  amount DECIMAL(10, 2) NOT NULL CHECK (amount > 0),\n  status VARCHAR(50) DEFAULT \'pending\',\n  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,\n  \n  -- Foreign key links to users table\n  FOREIGN KEY (user_id) REFERENCES users(id)\n);\n\n-- Constraints explained:\n-- NOT NULL: Column cannot be empty\n-- UNIQUE: All values must be different\n-- CHECK: Values must meet a condition\n-- DEFAULT: Value if none provided\n-- FOREIGN KEY: Must match a value in another table',
            codeLanguage: 'sql',
            order: 2,
          ),
        ],
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'PRIMARY KEY ensures each row has a unique, non-null identifier. It\'s essential for identifying and linking records.',
            ),
            QuizQuestion(
              question: 'Which data type is best for storing prices like \$99.99?',
              options: [
                'INT',
                'VARCHAR(10)',
                'DECIMAL(10, 2)',
              ...
              correctAnswerIndex: 2,
              explanation: 'DECIMAL(10, 2) stores exact decimal numbers with 2 decimal places - perfect for money. FLOAT can have rounding errors.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'NOT NULL means the column cannot be empty - every row must have a value for that column.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'A FOREIGN KEY creates a relationship between tables by referencing the primary key of another table, ensuring referential integrity.',
            ),
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'DEFAULT specifies a value to use when no value is provided during INSERT. In this case, the status would be \'pending\' by default.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Create a Customers Table',
          description: 'Create a "customers" table with: id (integer, primary key, auto increment), name (varchar 100, not null), email (varchar 255, unique), and created_at (timestamp with default current timestamp).',
          starterCode: '-- Create the customers table\n',
          language: 'sql',
          testCases: [
            TestCase(input: '', expectedOutput: 'CREATE TABLE customers (\n  id INT PRIMARY KEY AUTO_INCREMENT,\n  name VARCHAR(100) NOT NULL,\n  email VARCHAR(255) UNIQUE,\n  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP\n);'),
          ],
          hint: 'Define each column with its type and constraints. Use commas between columns.',
    ...
    return [
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            title: 'What is OOP? 🏗️',
            content: 'Object-Oriented Programming organizes code into objects - bundles of data and functionality.\n\nKey concepts:\n• **Class**: A blueprint for creating objects\n• **Object**: An instance of a class\n• **Attributes**: Data stored in an object\n• **Methods**: Functions that belong to an object',
            order: 0,
          ),
          TheorySlide(
            title: 'Why Use OOP? 💡',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Initialize object attributes', 'Delete object', 'Print object', 'Import modules'],
              correctAnswerIndex: 0,
              explanation: '__init__ is the constructor that sets up initial state when an object is created.',
            ),
            QuizQuestion(
              question: 'What does "self" refer to?',
              options: ['The class itself', 'The current instance', 'The parent class', 'A global variable'],
              correctAnswerIndex: 1,
              explanation: 'self refers to the current instance of the class being created or used.',
            ),
            QuizQuestion(
              question: 'How do you create an object from class Dog?',
              options: ['Dog.new()', 'new Dog()', 'Dog()', 'create Dog'],
              correctAnswerIndex: 2,
              explanation: 'In Python, you create objects by calling the class name like a function: Dog()',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
...
print(car.describe())''',
          testCases: [
            TestCase(input: '', expectedOutput: 'Brand: Toyota'),
          ],
          hint: 'Step 1: self.brand = brand\nStep 2: return f"Brand: {self.brand}"',
          solution: '''class Car:
    def __init__(self, brand):
        self.brand = brand
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Creates new object', 'Calls parent class methods', 'Deletes class', 'Makes code faster'],
              correctAnswerIndex: 1,
              explanation: 'super() allows calling methods from the parent class.',
            ),
            QuizQuestion(
              question: 'How do you create a child class?',
              options: ['class Child extends Parent', 'class Child(Parent)', 'class Child: Parent', 'Child = Parent.extend()'],
              correctAnswerIndex: 1,
              explanation: 'In Python, put the parent class name in parentheses: class Child(Parent)',
            ),
            QuizQuestion(
              question: 'What is method overriding?',
              options: ['Deleting a method', 'Redefining parent method in child', 'Calling a method twice', 'Making method private'],
              correctAnswerIndex: 1,
              explanation: 'Override means defining a method in child class with same name as parent to replace behavior.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Create Student Class',
          description: 'Create Student class inheriting from Person with grade attribute.',
          language: 'python',
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 1,
              explanation: 'Only values greater than 2 pass the filter: 3 and 4.',
            ),
            QuizQuestion(
              question: 'Which is equivalent to: result = []; for x in items: result.append(x*2)?',
              options: ['[x*2 in items]', '[x*2 for x in items]', '[for x in items: x*2]', 'items.map(x*2)'],
              correctAnswerIndex: 1,
      ...
      Lesson(
        ...
        theorySlides: [
          ...
          TheorySlide(
            ...
            codeSnippet: '''students = [("Alice", 85), ("Bob", 92), ("Charlie", 78)]
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['lambda: a+b', 'lambda a,b: a+b', 'def lambda(a,b)', 'a,b => a+b'],
              correctAnswerIndex: 1,
              explanation: 'Syntax: lambda parameters: expression',
            ),
            QuizQuestion(
              question: 'What can lambda functions contain?',
              options: ['Multiple statements', 'A single expression', 'Loops and if/else blocks', 'Class definitions'],
              correctAnswerIndex: 1,
              explanation: 'Lambda functions can only contain a single expression, not multiple statements.',
            ),
            QuizQuestion(
              question: 'What does map(lambda x: x**2, [1,2,3]) return?',
              options: ['[1,2,3]', '[1,4,9]', '6', 'Error'],
              correctAnswerIndex: 1,
              explanation: 'map() applies the lambda to each element: 1²=1, 2²=4, 3²=9',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
...
print(result)''',
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            title: 'Try/Except 🛡️',
            content: 'Handle errors without crashing your program.\n\nCommon exceptions:\n• ValueError - wrong value type\n• TypeError - wrong operation on type\n• ZeroDivisionError - divide by zero\n• FileNotFoundError - missing file',
            order: 0,
          ),
          TheorySlide(
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              correctAnswerIndex: 0,
              explanation: 'A bare "except:" catches all exceptions (though "except Exception:" is preferred).',
            ),
            QuizQuestion(
              question: 'What does "raise" do?',
              options: ['Catch exception', 'Create/throw exception', 'Print error', 'Exit program'],
              correctAnswerIndex: 1,
              explanation: 'raise creates and throws an exception that can be caught by try/except.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
...
print(safe_divide(10, 0))''',
          testCases: [
            TestCase(input: '', expectedOutput: '5.0\nError'),
          ],
...
print(safe_divide(10, 0))''',
  ...
  flex: 1 0 200px;
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              question: 'What does flex-direction: column do?',
              options: ['Items side by side', 'Items stacked vertically', 'Makes columns equal', 'Hides items'],
              correctAnswerIndex: 1,
              explanation: 'column changes the main axis to vertical, stacking items top to bottom.',
            ),
            QuizQuestion(
              question: 'What does flex: 1 mean?',
              options: ['Fixed width of 1px', 'Item takes equal share of space', 'Only 1 item visible', 'Error'],
              correctAnswerIndex: 1,
              explanation: 'flex: 1 means flex-grow: 1, allowing the item to grow and fill available space.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
  ...
  /* Add flexbox centering */
          ...
          testCases: [
            TestCase(input: '', expectedOutput: 'display: flex; justify-content: center; align-items: center;'),
          ],
  ...
  align-items: center;
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            title: 'CSS Grid 🔲',
            content: 'CSS Grid creates layouts with rows AND columns.\n\nKey properties:\n• grid-template-columns\n• grid-template-rows\n• gap\n• fr unit (fraction)',
            order: 0,
          ),
          TheorySlide(
...
.sidebar { grid-area: sidebar; }''',
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              options: ['Fixed columns', 'Fills row with as many columns as fit', 'Single column', 'Error'],
              correctAnswerIndex: 1,
              explanation: 'auto-fit creates as many columns as can fit in the available space.',
            ),
            QuizQuestion(
              question: 'Which creates a 2x2 grid?',
              options: ['grid: 2x2', 'grid-template: 2 2', 'grid-template-columns: 1fr 1fr; grid-template-rows: 1fr 1fr', 'columns: 2; rows: 2'],
              correctAnswerIndex: 2,
              explanation: 'Define both columns and rows with grid-template-columns and grid-template-rows.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
  ...
  /* Create 3 equal columns with 16px gap */
          ...
          testCases: [
            TestCase(input: '', expectedOutput: 'display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px;'),
          ],
  ...
  gap: 16px;
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            title: 'CSS Variables ✨',
            content: 'Store and reuse values throughout your stylesheet.\n\nDefine with --name, use with var(--name)',
            order: 0,
          ),
          TheorySlide(
            title: 'Example',
...
.btn {
  /* Use --primary for background */
          ...
          testCases: [
            TestCase(input: '', expectedOutput: '--primary: #0066ff; background: var(--primary);'),
          ],
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Runs faster', 'Loops forever', 'Increases size', 'Pauses'],
              correctAnswerIndex: 1,
...
.box {
  animation: pulse 1s infinite;
          ...
          testCases: [
            TestCase(input: '', expectedOutput: '0% { transform: scale(1); } 50% { transform: scale(1.1); } 100% { transform: scale(1); }'),
          ],
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Only support mobile', 'Write mobile CSS first, add desktop', 'Test mobile first', 'Ignore desktop'],
              correctAnswerIndex: 1,
              explanation: 'Mobile-first uses base styles for mobile, media queries for larger screens.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Responsive Grid',
          description: 'Create grid that is 1 column on mobile, 2 on tablet (768px+).',
          language: 'css',
          starterCode: '''.grid {
  display: grid;
...
/* Add media query for 768px+ */''',
          testCases: [
            TestCase(input: '', expectedOutput: '@media (min-width: 768px) { .grid { grid-template-columns: 1fr 1fr; } }'),
          ],
          hint: 'Use @media (min-width: 768px)',
          solution: '''.grid {
  display: grid;
...
function fetchData(url, timeout = 5000, retries = timeout > 3000 ? 1 : 3) {
  console.log(`Fetching \${url}, timeout: \${timeout}, retries: \${retries}`);
          ...
          TheorySlide(
            ...
            content: 'Shorter syntax for objects:\n• Property shorthand\n• Method shorthand\n• Computed property names',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Creates array', 'Destructures array', 'Copies array', 'Error'],
              correctAnswerIndex: 1,
              explanation: 'Array destructuring assigns array elements to variables.',
            ),
            QuizQuestion(
            ...
            QuizQuestion(
              question: 'What happens when you call greet() with function greet(name = "World")?',
              options: ['Error - missing argument', 'Returns undefined', 'Uses "World" as name', 'Returns null'],
              correctAnswerIndex: 2,
              explanation: 'Default parameters are used when arguments are undefined or not provided.',
            ),
            QuizQuestion(
              question: 'What is { name, age } shorthand for?',
              options: ['{ name: "name", age: "age" }', '{ name: name, age: age }', '[name, age]', 'Error'],
              correctAnswerIndex: 1,
              explanation: 'Property shorthand creates properties with variable names and values.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Destructure User',
          description: 'Extract name and email from the user object using destructuring.\n\nInstead of:\nconst name = user.name;\nconst email = user.email;\n\nUse:\nconst { name, email } = user;',
          language: 'javascript',
          starterCode: '''const user = { name: "Alex", email: "alex@test.com", age: 25 };
...
console.log(name, email);''',
          ...
          solution: '''const user = { name: "Alex", email: "alex@test.com", age: 25 };
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Spread expands elements:\n• Combine arrays\n• Clone objects\n• Pass arguments',
            order: 0,
          ),
          TheorySlide(
            title: 'Examples',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Pause function', 'Collect remaining args', 'Return nothing', 'Loop'],
              correctAnswerIndex: 1,
              explanation: 'Rest (...args) collects remaining arguments into array.',
            ),
            QuizQuestion(
              question: 'What does { ...obj1, ...obj2 } produce if both have property "x"?',
              options: ['Error - duplicate key', 'obj1.x wins', 'obj2.x wins', 'Both values in array'],
              correctAnswerIndex: 2,
              explanation: 'In object spread, later properties override earlier ones.',
            ),
            QuizQuestion(
              question: 'Where must rest parameter appear in function signature?',
              options: ['First position', 'Any position', 'Last position', 'Middle position'],
              correctAnswerIndex: 2,
              explanation: 'Rest parameter must be the last parameter in a function.',
            ),
            QuizQuestion(
              question: 'What does const [a, ...b] = [1, 2, 3] assign to b?',
              options: ['2', '[2, 3]', '3', 'undefined'],
              correctAnswerIndex: 1,
              explanation: 'Rest in destructuring collects remaining elements into an array.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Transform arrays without mutation:\n• **map**: Transform each element\n• **filter**: Keep matching elements\n• **reduce**: Combine to single value\n• **find**: Get first match',
            order: 0,
          ),
          TheorySlide(
...
console.log(formValid); // false''',
          ...
          TheorySlide(
            ...
            content: 'More useful array methods:\n• includes(): Check if element exists\n• flat(): Flatten nested arrays\n• flatMap(): Map then flatten',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Modified array', 'New array with matches', 'Boolean', 'Single value'],
              correctAnswerIndex: 1,
              explanation: 'filter() returns new array with elements passing the test.',
            ),
            QuizQuestion(
              question: 'What does find() return if no element matches?',
              options: ['Empty array', 'null', 'undefined', 'false'],
              correctAnswerIndex: 2,
              explanation: 'find() returns undefined when no element satisfies the condition.',
            ),
            QuizQuestion(
              question: 'What does [1,2,3].some(n => n > 2) return?',
              options: ['[3]', '3', 'true', 'false'],
              correctAnswerIndex: 2,
              explanation: 'some() returns true because at least one element (3) is greater than 2.',
            ),
            QuizQuestion(
              question: 'What does [1,2,3].every(n => n > 0) return?',
              options: ['[1,2,3]', '3', 'true', 'false'],
              correctAnswerIndex: 2,
              explanation: 'every() returns true because all elements are greater than 0.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
...
console.log(result);''',
          testCases: [
            TestCase(input: '', expectedOutput: '56'),
          ],
...
console.log(result);''',
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            title: 'Promises ⏳',
            content: 'A Promise represents future value.\n\nStates:\n• **pending**: Initial\n• **fulfilled**: Success\n• **rejected**: Error',
            order: 0,
          ),
          TheorySlide(
...
fetchData()
  ...
  .then(data => console.log(data)); // Continues with cached data''',
          ...
          TheorySlide(
            ...
            content: 'More Promise combinators:\n• allSettled(): Wait for all, never rejects\n• race(): First to settle wins\n• any(): First to fulfill wins',
            codeSnippet: '''// Promise.allSettled - get all results regardless of success/failure
const promises = [
  fetch("/api/users"),
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Success', 'Rejection/errors', 'Pending state', 'All states'],
              correctAnswerIndex: 1,
              explanation: '.catch() handles rejected promises and errors.',
            ),
            QuizQuestion(
              question: 'What happens if one promise in Promise.all() rejects?',
              options: ['Other promises continue', 'All results are returned', 'Entire Promise.all rejects', 'Only failed one is ignored'],
              correctAnswerIndex: 2,
              explanation: 'Promise.all() fails fast - it rejects immediately when any promise rejects.',
            ),
            QuizQuestion(
              question: 'What does .finally() do?',
              options: ['Only runs on success', 'Only runs on failure', 'Runs after success or failure', 'Cancels the promise'],
              correctAnswerIndex: 2,
              explanation: 'finally() always executes after the promise settles, regardless of outcome.',
            ),
            QuizQuestion(
              question: 'Which method waits for all promises and never rejects?',
              options: ['Promise.all()', 'Promise.race()', 'Promise.allSettled()', 'Promise.any()'],
              correctAnswerIndex: 2,
              explanation: 'Promise.allSettled() waits for all promises and returns their results, never rejects.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Anywhere', 'Inside async function', 'Only in callbacks', 'Only in classes'],
              correctAnswerIndex: 1,
              explanation: 'await can only be used inside async functions.',
            ),
            QuizQuestion(
              question: 'What is the benefit of using try/catch with async/await?',
              options: ['Makes code faster', 'Handles errors synchronously-looking way', 'Prevents all errors', 'Not needed with async/await'],
              correctAnswerIndex: 1,
              explanation: 'try/catch provides clean, synchronous-style error handling for async code.',
            ),
            QuizQuestion(
              question: 'How do you run multiple awaits in parallel?',
              options: ['Put them on same line', 'Use Promise.all()', 'Use async.parallel()', 'Not possible'],
              correctAnswerIndex: 1,
              explanation: 'Promise.all() runs multiple promises in parallel and awaits all results.',
            ),
            QuizQuestion(
              question: 'What does an async function always return?',
              options: ['undefined', 'The return value directly', 'A Promise', 'An async object'],
              correctAnswerIndex: 2,
              explanation: 'Async functions always return a Promise, even if you return a plain value.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
        ...
        quiz: Quiz(
          questions: [
            ...
            QuizQuestion(
              ...
              options: ['Only matching rows', 'All rows from left table', 'All rows from right table', 'All rows from both tables'],
              correctAnswerIndex: 3,
            ...
            QuizQuestion(
              ...
              options: ['To duplicate a table', 'To find hierarchical relationships in same table', 'To delete duplicates', 'To create a backup'],
              correctAnswerIndex: 1,
              explanation: 'Self JOINs are useful for hierarchical data like employees/managers or finding relationships within the same table.',
            ),
            QuizQuestion(
              question: 'How many tables can you JOIN in one query?',
              options: ['Only 2', 'Maximum 5', 'Maximum 10', 'As many as needed'],
              correctAnswerIndex: 3,
              explanation: 'You can chain as many JOINs as needed, though performance may decrease with many tables.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
          title: 'Join Users and Orders',
          description: 'Write a query to get:\n• users.name\n• orders.total\n\nUse LEFT JOIN to include users even if they have no orders.\n\nStructure:\nSELECT ... FROM users LEFT JOIN orders ON ...',
          language: 'sql',
...
''',
          testCases: [
            TestCase(input: '', expectedOutput: 'SELECT users.name, orders.total FROM users LEFT JOIN orders ON users.id = orders.user_id;'),
          ],
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Only in WHERE', 'Only in SELECT', 'WHERE, SELECT, FROM', 'Only in FROM'],
              correctAnswerIndex: 2,
              explanation: 'Subqueries can be in SELECT, FROM, or WHERE clauses.',
            ),
            QuizQuestion(
              question: 'What does EXISTS return?',
              options: ['The matching rows', 'A count of rows', 'TRUE or FALSE', 'NULL'],
              correctAnswerIndex: 2,
              explanation: 'EXISTS returns TRUE if the subquery returns any rows, FALSE otherwise.',
            ),
            QuizQuestion(
              question: 'What is a correlated subquery?',
              options: ['A subquery with GROUP BY', 'A subquery that references the outer query', 'A subquery with JOIN', 'A subquery with ORDER BY'],
              correctAnswerIndex: 1,
              explanation: 'A correlated subquery references columns from the outer query and executes once per outer row.',
            ),
            QuizQuestion(
              question: 'When is EXISTS often better than IN?',
              options: ['For small datasets', 'When checking if rows exist (not values)', 'For string comparisons', 'Never'],
              correctAnswerIndex: 1,
              explanation: 'EXISTS can be faster because it stops as soon as it finds a match, while IN evaluates all values.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
...
''',
          testCases: [
            TestCase(input: '', expectedOutput: 'SELECT name, price FROM products WHERE price > (SELECT AVG(price) FROM products);'),
          ],
...
HAVING AVG(total) BETWEEN 100 AND 500;''',
          ...
          TheorySlide(
            ...
            content: 'Combine all clauses effectively:\n• WHERE: Filter rows BEFORE grouping\n• GROUP BY: Create groups\n• HAVING: Filter groups AFTER aggregation',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Same thing', 'WHERE filters rows, HAVING filters groups', 'HAVING is faster', 'WHERE is deprecated'],
              correctAnswerIndex: 1,
              explanation: 'WHERE filters before grouping, HAVING after.',
            ),
            QuizQuestion(
              question: 'What happens when you GROUP BY multiple columns?',
              options: ['Error occurs', 'Only first column is used', 'Creates unique combinations of all columns', 'Columns are merged'],
              correctAnswerIndex: 2,
              explanation: 'GROUP BY multiple columns creates a group for each unique combination of values.',
            ),
            QuizQuestion(
              question: 'Can you use WHERE and HAVING in the same query?',
              options: ['No, only one allowed', 'Yes, WHERE runs first', 'Yes, HAVING runs first', 'Only with subqueries'],
              correctAnswerIndex: 1,
              explanation: 'Yes! WHERE filters rows before grouping, HAVING filters groups after aggregation.',
            ),
            QuizQuestion(
              question: 'Which is correct execution order?',
              options: ['SELECT → FROM → WHERE', 'FROM → WHERE → GROUP BY → HAVING', 'GROUP BY → WHERE → HAVING', 'HAVING → GROUP BY → WHERE'],
              correctAnswerIndex: 1,
              explanation: 'SQL executes: FROM → WHERE → GROUP BY → HAVING → SELECT → ORDER BY.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
...
''',
          testCases: [
            TestCase(input: '', expectedOutput: 'SELECT customer_id, COUNT(*) as order_count FROM orders GROUP BY customer_id HAVING COUNT(*) > 5;'),
          ],
...
HAVING COUNT(*) > 5;''',
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            title: 'Window Functions 🪟',
            content: 'Perform calculations across rows:\n• ROW_NUMBER(): Sequential number\n• RANK(): Rank with gaps\n• LAG/LEAD: Previous/next row\n• SUM() OVER: Running total',
            order: 0,
          ),
          TheorySlide(
            title: 'Example',
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Deletes partitions', 'Groups for window function', 'Creates new table', 'Filters rows'],
              correctAnswerIndex: 1,
              explanation: 'PARTITION BY divides rows into groups for window calculations.',
            ),
            QuizQuestion(
              question: 'What does LAG() return?',
              options: ['Next row value', 'Previous row value', 'Current row value', 'Random row value'],
              correctAnswerIndex: 1,
              explanation: 'LAG() returns the value from the previous row in the result set.',
            ),
            QuizQuestion(
              question: 'How do you calculate a running total?',
              options: ['GROUP BY with SUM', 'SUM() OVER (ORDER BY date)', 'RUNNING_TOTAL()', 'CUMULATIVE_SUM()'],
              correctAnswerIndex: 1,
              explanation: 'SUM() OVER with ORDER BY calculates a running total that accumulates row by row.',
            ),
            QuizQuestion(
              question: 'Difference between ROW_NUMBER and RANK?',
              options: ['No difference', 'RANK skips numbers for ties', 'ROW_NUMBER skips numbers', 'RANK starts at 0'],
              correctAnswerIndex: 1,
              explanation: 'RANK gives same number to ties and skips next numbers. ROW_NUMBER is always sequential.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
...
FROM products;''',
          testCases: [
            TestCase(input: '', expectedOutput: 'ROW_NUMBER() OVER (ORDER BY price DESC) as rank'),
          ],
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['On primary keys', 'On frequently updated columns', 'On WHERE columns', 'On JOIN columns'],
              correctAnswerIndex: 1,
              explanation: 'Frequent updates slow down with indexes due to maintenance.',
            ),
            QuizQuestion(
              question: 'In composite index (A, B, C), which queries use it?',
              options: ['Only WHERE A', 'WHERE A, WHERE A+B, WHERE A+B+C', 'Any combination of A, B, C', 'Only WHERE A+B+C'],
              correctAnswerIndex: 1,
              explanation: 'Composite indexes work left-to-right. Queries must include leftmost columns to use the index.',
            ),
            QuizQuestion(
              question: 'What does EXPLAIN help you find?',
              options: ['Syntax errors', 'Missing tables', 'Query execution plan and index usage', 'User permissions'],
              correctAnswerIndex: 2,
              explanation: 'EXPLAIN shows how the database executes a query, including which indexes are used.',
            ),
            QuizQuestion(
              question: 'What is "cardinality" in index context?',
              options: ['Index size', 'Number of unique values', 'Query speed', 'Table row count'],
              correctAnswerIndex: 1,
              explanation: 'Cardinality is the number of unique values. High cardinality columns (many unique values) benefit most from indexes.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
...
''',
          testCases: [
            TestCase(input: '', expectedOutput: 'CREATE INDEX idx_category ON products(category);'),
          ],
...
useEffect(() => {
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['On mount only', 'Before every re-run and unmount', 'Never', 'On click'],
              correctAnswerIndex: 1,
              explanation: 'Cleanup runs before re-running effect and on unmount.',
            ),
            QuizQuestion(
              question: 'What does an empty dependency array [] mean?',
              options: ['Run on every render', 'Run only once on mount', 'Never run', 'Error'],
              correctAnswerIndex: 1,
              explanation: 'Empty array means effect runs only once when component mounts.',
            ),
            QuizQuestion(
              question: 'Can you use hooks inside if statements?',
              options: ['Yes, always', 'No, must be at top level', 'Only useState', 'Only useEffect'],
              correctAnswerIndex: 1,
              explanation: 'Hooks must be called at the top level to ensure consistent order between renders.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
  ...
  return <div>{count}</div>;
          ...
          testCases: [
            TestCase(input: '', expectedOutput: 'setInterval return () => clearInterval'),
          ],
...
// const [isOn, toggle] = useToggle();''',
          testCases: [
            TestCase(input: '', expectedOutput: 'useState setX(!x)'),
          ],
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Provider', 'Consumer', 'Current context value', 'Context object'],
              correctAnswerIndex: 2,
              explanation: 'useContext returns the current value from nearest Provider.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
...
function Button() {
  ...
  return <button>{theme}</button>;
          ...
          testCases: [
            TestCase(input: '', expectedOutput: 'ThemeContext.Provider value useContext(ThemeContext)'),
          ],
      ...
      Lesson(
        ...
        theorySlides: [
          TheorySlide(
            ...
            content: 'Prevent unnecessary re-renders:\n• **React.memo**: Memoize components\n• **useMemo**: Memoize values\n• **useCallback**: Memoize functions',
            order: 0,
          ),
          TheorySlide(
...
const Child = React.memo(({ onClick }) => {
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Every render', 'When dependencies change', 'Never', 'On click'],
              correctAnswerIndex: 1,
              explanation: 'useMemo only recalculates when dependencies change.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
  ...
  return <ul>{filtered.map(i => <li>{i}</li>)}</ul>;
          ...
          testCases: [
            TestCase(input: '', expectedOutput: 'useMemo(() => items.filter [items]'),
          ],
        ...
        quiz: Quiz(
          questions: [
            QuizQuestion(
              ...
              options: ['Render errors', 'Event handler errors', 'Lifecycle errors', 'Constructor errors'],
              correctAnswerIndex: 1,
              explanation: 'Error boundaries dont catch event handler errors - use try/catch.',
            ),
          ],
        ),
        codingChallenge: CodingChallenge(
  ...
  return (
    ...
    <UserProfile />
          ...
          testCases: [
            TestCase(input: '', expectedOutput: '<ErrorBoundary><UserProfile /></ErrorBoundary>'),
          ],
